    ...
    <div className="w-full max-w-4xl mx-auto">
      ...
      >
        <motion.button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-full text-white transition-colors border border-white/20"
        ...
        <div className="relative bg-white/10 backdrop-blur-sm rounded-full border border-white/20 overflow-hidden">
          ...
          <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex items-center gap-2">
            ...
            <Button
              ...
              className="p-2 bg-cyan-500 hover:bg-cyan-600 text-white rounded-full disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <motion.div
                  animate={{ rotate: 360 }}
